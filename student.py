...
# Variables
    ...
    #First Image Upload
        img=Image.open(r"Project_Image\rupeshRecognition.jpg")
    ...
    #Button frame
        ...
        update_photo_btn=Button(btn_frame1,text="Update Photo Sample",command=self.Upload_photo,width=43,font=("times new roman",10,"bold"),bg="blue",fg="white")
    ...
    #============== combobox for select=============
        self.search_var=StringVar()
        search_combo=ttk.Combobox(search_frame,textvariable=self.search_var,font=("times new roman",12,"bold"),state="readonly",width=13)
    ...
    #==============enter the data===============
        ...
        search_entry=ttk.Entry(search_frame,textvariable=self.search_txt,width=13,font=("times new roman",12,"bold"))
...
#     #UPDATE FUNCTION
    ...
    def search(self):
        ...
        # my_cursor.execute("select * from student where phoneNo ='%s' or enrollNo='%s' ")
...
#patha user name#
                        ...
                        cv2.imwrite(file_name_path,face)   #Saves an image to a specified file or any storage device.
                        cv2.putText(face,str(img_id),(50,50),cv2.FONT_HERSHEY_COMPLEX,2,(0,225,0),2)  #draw a text string on any image
                        cv2.imshow("Cropped Face",face)     # display an image in a window
